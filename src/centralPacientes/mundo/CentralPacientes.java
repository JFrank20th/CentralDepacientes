...
public class CentralPacientes {
    ...
    /**
     * Retornar ek nombre del paciente que tenga el
     * codigo mayor
     *
     * @return respuesta4
     */
    public String metodo4() {
        int  codigoMayor = Integer.MIN_VALUE;
        String nombrePacienteCodigoMayor="";
        Paciente pac = primero;
        while (pac != null){
            if (pac.darCodigo() > codigoMayor){
                codigoMayor = pac.darCodigo();
